                      ...
                      <div className="p-6 flex-1 flex flex-col">
                        ...
                        <div className="space-y-3 mt-auto">
                          ...
                          <button
                            ...
                            className="w-full bg-indigo-500 hover:bg-indigo-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-md hover:shadow-lg cursor-pointer"
                          >
                            View Details
